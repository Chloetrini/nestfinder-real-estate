...
import { createProperty, updateProperty as updatePropertyAPI } from "@/api/properties";

// ---- BACKEND ADDED: imported Modal component ----
import Modal from "@/components/ui/modal";

// ---- BACKEND ADDED: imported Nigeria states data ----
import { allStates, getCitiesByState } from "@/constants/nigeria-states";
...
interface PropertyFormProps {
    /** When given, the form edits this property; otherwise it creates a new one */
    property?: PropertyType;
}

export const PropertyForm: React.FC<PropertyFormProps> = ({ property: editingProperty }) => {
    const { publishProperty, updateProperty } = useProperties();
  ...
  setErrors((prev) => ({ ...prev, [name]: undefined }));
    ...
    return (
        <div className="flex flex-col bg-[#E5E7EB] dark:bg-gray-950 min-h-screen pb-20 overflow-x-hidden">

            {/* Nav */}
            <nav className="h-[76px] bg-white dark:bg-gray-900 px-4 md:px-10 flex items-center border-b border-[#BAB9B9] dark:border-gray-600 shrink-0">
                <h1 className="font-['Lato'] font-bold text-[20px] md:text-[22px] text-[#023337] dark:text-gray-100">
            ...
            <div className="flex flex-col sm:flex-row justify-between px-4 md:px-10 py-6 items-start sm:items-center gap-4">
                <div className="flex flex-col gap-[8px]">
                    <h1 className="font-bold font-['Lato'] text-[20px] md:text-[22px] text-[#023337] dark:text-gray-100 ">Add New Property</h1>
                    <p className="font-['Lato'] text-[14px] text-[#000000] dark:text-gray-100">Fill in the details below to list a new property</p>
                </div>
                <div className="flex gap-3 w-full sm:w-auto shrink-0">
                    <button
                        type="button"
                        onClick={() => handleSubmit('publish')} disabled={isLoading}
                        className="flex-1 sm:flex-none sm:w-[160px] h-[48px] rounded-[8px] border-[1px] border-[#75928B] bg-[#1A3C34] dark:bg-[#24574a] font-bold text-[15px] font-['Lato'] text-[#FFFFFF] whitespace-nowrap px-3"
                    >
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none sm:w-[150px] h-[48px] rounded-[8px] border-[1px] bg-[#FFFFFF] dark:bg-gray-900 border-[#75928B] flex items-center justify-center gap-2 font-bold text-[15px] text-[#031D17] dark:text-gray-100 font-['Lato'] whitespace-nowrap px-3"
                    >
                        <img className="w-[12.8px] h-[12.8px] dark:invert" src={save} alt="" />
                        Save to Draft
                    </button>
                </div>
            </div>
            ...
            <div className="flex flex-col xl:flex-row gap-6 px-4 md:px-5">
                ...
                <div className="bg-white dark:bg-gray-900 p-4 md:p-8 flex-1 rounded-[8px] min-w-0">
                    <div className="mb-6">
                        <h2 className="font-bold font-['Lato'] text-[20px] md:text-[22px] text-[#1A3C34] dark:text-[#8fd3c0]">Basic Information</h2>
                    </div>

                    <div className="flex flex-col gap-5 max-[321px]:text-[13px]">
                        {/* Property Title */}
                        <div className="flex flex-col gap-[12px]">
                            <label className="font-['Lato'] font-bold text-[16px] text-[#444545] dark:text-gray-300">Property Title</label>
                            <input
                                className={`w-full max-w-[563px] h-[48px] rounded-[8px] border-[1px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 outline-none ${errors.propertyName ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                name="propertyName"
                        ...
                        {/* Description */}
                        <div className="flex flex-col gap-[12px]">
                            <label className="font-bold font-['Lato'] text-[16px] text-[#444545] dark:text-gray-300">Property Description</label>
                            <textarea
                                className={`w-full max-w-[563px] min-h-[155px] rounded-[8px] border-[1px] p-3 bg-[#F9FAFB] dark:bg-gray-800 resize-none outline-none ${errors.propertyDescription ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                        ...
                        {/* Price */}
                        <div className="flex flex-col gap-[12px]">
                            <label className="font-['Lato'] font-bold text-[18px] text-[#444545] dark:text-gray-300">Price (₦)</label>
                            <input
                                className={`w-full max-w-[563px] h-[48px] rounded-[8px] border-[1px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 outline-none ${errors.price ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                name="price"
                                placeholder="0.00"
                                step={1000000}
                                min={0}
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-[20px] max-w-[563px]">
                            <div className="flex flex-col gap-[12px]">
                                <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Property Type</label>
                                <div className="relative w-full">
                                    <select
                                        name="propertyType"
                                        value={form.propertyType}
                                        onChange={handleChange}
                                        className="border-[1px] border-[#E5E7EB] dark:border-gray-700 rounded-[8px] h-[48px] w-full outline-none bg-[#F9FAFB] dark:bg-gray-800 px-2 pr-[40px] appearance-none cursor-pointer"
                                    >
                            ...
                            <div className="flex flex-col gap-[12px]">
                                <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Listing Status</label>
                                <div className="relative w-full">
                                    <select
                                        name="sale"
                                        value={form.sale}
                        ...
                        <div className="flex flex-col gap-[12px] w-full md:w-[271.5px]">
                            <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Agent Name</label>
                            <input
                               
                                className={`border-[1px] rounded-[8px] h-[48px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 outline-none ${errors.agentName ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                name="agentName"
                        ...
                        <div className="flex flex-col gap-[12px] w-full md:w-[271.5px]">
                            <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Agent Phone</label>
                            <input
                                className={`border-[1px] rounded-[8px] h-[48px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 outline-none ${errors.agentPhone ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                name="agentPhone"
                        ...
                        <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Discount (optional e.g 10%)</label>
                        <input className="w-full md:max-w-[563px] border-[1px] rounded-[8px] h-[48px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 border-[#E5E7EB] dark:border-gray-700 outline-none" name="discount" value={form.discount} onChange={handleChange} placeholder="e.g 10%" />
                        </div>
                        {/* Location */}
                        <div className="pt-10">
                            <h3 className="font-bold text-[18px] text-[#023337] dark:text-gray-100">Location</h3>
                            <div className="flex flex-col sm:flex-row gap-[20px] max-w-[563px] pt-2">
                                <div className="flex flex-col flex-1">
                                    <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300 mb-3">State</label>
                                    <div className="relative w-full">
                                        <select
                                            ...
                                            className={`w-full h-[48px] border-[1px] rounded-[8px] py-[10px] px-[12px] pr-[40px] bg-[#F9FAFB] dark:bg-gray-800 outline-none appearance-none cursor-pointer ${errors.state ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}>
                                ...
                                <div className="flex flex-col flex-1">
                                    <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300 mb-3">City</label>
                                    <div className="relative w-full">
                                        <select
                                            value={form.location.city}
                                            onChange={(e) => nestedHandleChange("location", "city", e.target.value)}
                                            className={`w-full h-[48px] border-[1px] rounded-[8px] py-[10px] px-[12px] pr-[40px] bg-[#F9FAFB] dark:bg-gray-800 outline-none appearance-none cursor-pointer ${errors.city ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}>
                            ...
                            <div className="flex flex-col gap-[12px] py-4 max-w-[563px]">
                                <label className="font-['Lato'] font-bold text-[16px] text-[#444545] dark:text-gray-300">Full Address</label>
                                <input
                                    className={`w-full h-[48px] border-[1px] rounded-[8px] py-[10px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 outline-none mt-2 ${errors.fullAddress ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                        ...
                        {/* Property Details */}
                        <div className="pt-4">
                            <h2 className="font-bold text-[16px] text-[#023337] dark:text-gray-100 mb-4">Property Details</h2>
                            <div className="grid grid-cols-3 gap-4 max-w-[563px]">
                                <div className="flex flex-col gap-2">
                                    <label className="font-bold text-[15px] max-[321px]:text-[13px] text-[#444545] dark:text-gray-300">Bedroom</label>
                                    <div className="relative w-full">
                                        <select
                                            value={form.propertyDetails.bedrooms}
                                            onChange={(e) => nestedHandleChange("propertyDetails", "bedrooms", Number(e.target.value))}
                                            className={`border-[1px] w-full h-[48px] rounded-[8px] px-[10px] pr-[40px] bg-[#F9FAFB] dark:bg-gray-800 outline-none appearance-none cursor-pointer ${errors.bedrooms ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                        >
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="font-bold text-[15px] max-[321px]:text-[13px] text-[#444545] dark:text-gray-300">Bathroom</label>
                                    <div className="relative w-full">
                                        <select
                                            value={form.propertyDetails.bathroom}
                                            onChange={(e) => nestedHandleChange("propertyDetails", "bathroom", Number(e.target.value))}
                                            className={`border-[1px] w-full h-[48px] rounded-[8px] px-[10px] pr-[40px] bg-[#F9FAFB] dark:bg-gray-800 outline-none appearance-none cursor-pointer ${errors.bathroom ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                                        >
                                            <option value="0">Select</option>
                                            {Array.from({ length: 50 }, (_, i) => i + 1).map((num) => (
                                                <option key={num} value={num}>{num}</option>
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="font-bold text-[15px] max-[321px]:text-[13px] text-[#444545] dark:text-gray-300">Size (sqm)</label>
                                    <input
                                        className={`border-[1px] w-full h-[48px] rounded-[8px] px-[10px] bg-[#F9FAFB] dark:bg-gray-800 outline-none ${errors.size ? "border-red-500" : "border-[#E5E7EB] dark:border-gray-700"}`}
                        ...
                        <div className="hidden xl:flex justify-end gap-3 mt-8">
                            <button
                                type="button"
                                onClick={() => handleSubmit('draft')} disabled={isLoading}
                                className="w-full sm:w-[140px] h-[48px] rounded-[8px] border-[1px] bg-white dark:bg-gray-900 border-[#75928B] flex items-center justify-center gap-2 font-bold text-[#031D17] dark:text-gray-100"
                            >
                                <img className="w-[12.8px] h-[12.8px] dark:invert" src={save} alt="" /> Save Draft
                            </button>
                            <button
                                type="button"
                                onClick={() => handleSubmit('publish')} disabled={isLoading}
                                className="w-full sm:w-[140px] h-[48px] rounded-[8px] bg-[#1A3C34] dark:bg-[#24574a] text-white font-bold "
                            >
                                {isLoading ? "Saving..." : editingProperty ? "Update Property" : "Publish Property"}
                            </button>
                        </div>
                ...
                <div className="bg-white dark:bg-gray-900 p-6 md:p-8 flex flex-col gap-8 rounded-[8px] w-full xl:w-[420px] xl:shrink-0 min-w-0 self-start">
                    {/* Upload */}
                    <div>
                        <h2 className="font-bold text-[20px] text-[#1A3C34] dark:text-[#8fd3c0] mb-2">Upload Property Image</h2>
                        ...
                        <label
                            ...
                            className={`relative w-full h-[266px] border-[1px] border-dashed rounded-[8px] flex flex-col items-center justify-center p-4 cursor-pointer transition-colors duration-200 ${
                                isDragging
                                    ? "border-[#1A3C34] dark:border-[#3b8a76] bg-[#f0fdf4] dark:bg-[#0f2a1c]"
                                    : "border-[#75928B]"
                            }`}
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center gap-3">
                                ...
                                <p className="text-[14px] text-black dark:text-gray-100 px-4">Drag and drop images here or click to browse</p>
                            </div>
                            <div className="mt-4 flex items-center gap-2 border border-gray-400 dark:border-gray-600 px-4 py-2 rounded-lg">
                                <img src={browse} alt="browse" className="w-4 h-4 dark:invert" />
                        ...
                        {imagePreviews.length > 0 && (
                            <p className="font-bold text-[14px] text-[#444545] dark:text-gray-300 mt-6 mb-2">Uploaded Images</p>
                        )}
                            ...
                            {imagePreviews.map((url, idx) => (
                                <div key={idx} className="relative">
                                    ...
                                    type="button"
                                        ...
                                        className="absolute top-1 right-1 bg-white dark:bg-gray-900 rounded-full p-1"
                                    >
                                        <img src={cancel} alt="remove" className="w-4 h-4 dark:invert" />
                                    </button>
                                </div>
                            ))}
                        </div>
                            ...
                            {amenityList.map((item) => (
                                <div
                                    ...
                                    className={`flex items-center gap-2 cursor-pointer border rounded-[8px] px-3 py-3 ${
                                        form.amenities.includes(item) ? "border-[#1A3C34] dark:border-[#3b8a76] bg-[#f0fdf4] dark:bg-[#0f2a1c]" : "border-[#E5E7EB] dark:border-gray-700"
                                    }`}
                                >
                                    <div className={`w-5 h-5 rounded-[4px] flex-shrink-0 flex items-center justify-center border transition-all ${
                                        form.amenities.includes(item)
                                            ? "bg-[#1A3C34] dark:bg-[#24574a] border-[#1A3C34] dark:border-[#3b8a76]"
                                    ...
                                    <span className="text-[13px] text-[#444545] dark:text-gray-300">{item}</span>
                                </div>
                            ))}
                        </div>
                    </div>
                {/* coordinates */}
                    <div className="flex flex-col gap-2">
                           ...
                           <h2 className="font-bold text-[16px] text-[#023337] dark:text-gray-100">Map Coordinates</h2>
                           <div className="flex w-full gap-5 mt-2">
                            <div className="flex flex-col">
                                <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Latitude</label>
                                <input type="number" className="w-full h-[40px] rounded-[8px] border-[1px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 border-[#E5E7EB] dark:border-gray-700 outline-none mt-3"
                                name="latitude"
                                placeholder="0.0000" 
                                min="0.0000"
                                step="0.0001"
                            ...
                            <div className="flex flex-col">
                                <label className="font-bold font-['Lato'] text-[15px] text-[#444545] dark:text-gray-300">Longitude</label>
                                <input type="number" className="w-full h-[40px] rounded-[8px] border-[1px] px-[12px] bg-[#F9FAFB] dark:bg-gray-800 border-[#E5E7EB] dark:border-gray-700 outline-none mt-3"
                                name="longitude" 
                                placeholder="0.0000"
                                min="0.0000"
            ...
            <div className="flex xl:hidden justify-end gap-3 mt-6 px-4 md:px-5">
                <button
                    type="button"
                    onClick={() => handleSubmit('draft')} disabled={isLoading}
                    className="flex-1 sm:flex-none sm:w-[140px] h-[48px] rounded-[8px] border-[1px] bg-white dark:bg-gray-900 border-[#75928B] flex items-center justify-center gap-2 font-bold text-[#031D17] dark:text-gray-100"
                >
                    <img className="w-[12.8px] h-[12.8px] dark:invert" src={save} alt="" /> Save Draft
                </button>
                <button
                    type="button"
                    onClick={() => handleSubmit('publish')} disabled={isLoading}
                    className="flex-1 sm:flex-none sm:w-[140px] h-[48px] rounded-[8px] bg-[#1A3C34] dark:bg-[#24574a] text-white font-bold"
                >
                     {isLoading ? "Saving..." : editingProperty ? "Update Property" : "Publish Property"}
                </button>
            </div>
