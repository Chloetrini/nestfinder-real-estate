    ...
    <div className="flex flex-nowrap justify-between items-center mt-4 mb-7 h-[42px] mx-auto w-full  gap-1 sm:gap-2 md:gap-4 Font-[Inter]">
      ...
      <div className="flex-shrink-0">
        <button
          ...
          className={`w-[60px] sm:w-[85px] md:w-[105px] h-[36px] sm:h-[42px] rounded-[8px] py-[8px] flex items-center justify-center gap-1 text-white text-[11px] sm:text-[12px] md:text-[14px] ${previous ? "bg-[#AEAEAE]" : "bg-[#1A3C34] dark:bg-[#24574a]"}`}
        >
        ...
        {visiblePages.map((page, id) => {
          ...
          if (isEllipsis) {
            return (
              <span
                key={`ellipsis-${id}`}
                className="w-[28px] sm:w-[32px] md:w-[36px] h-[28px] sm:h-[32px] md:h-[36px] rounded-[4px] border-[1px] border-gray-200 dark:border-gray-700 text-[11px] sm:text-[12px] md:text-[14px] flex items-center justify-center text-[#7A7978] dark:text-gray-400 flex-shrink-0"
              >
                ...
              </span>
            );
          ...
          return (
            <button
              ...
              style={{
                backgroundColor: color ? "#1A3C34" : "transparent",
      ...
      <div className="flex-shrink-0">
        <button
          onClick={handleNext}
          className={`w-[60px] sm:w-[85px] md:w-[105px] h-[36px] sm:h-[42px] rounded-[8px] py-[8px] flex flex-row-reverse items-center justify-center text-white gap-1 text-[11px] sm:text-[12px] md:text-[14px] ${next ? "bg-[#AEAEAE]" : "bg-[#1A3C34] dark:bg-[#24574a]"}`}
        >
