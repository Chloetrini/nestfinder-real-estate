...
import whyUs3 from "/src/assets/last.jpg"
import searchLogo from "/src/assets//search.svg"
import verifyIcon from "/src/assets/correct.svg"
import homeIcon from "/src/assets/modern.svg"
        ...
        <div className="flex flex-col justify-center items-center gap-[40px]  pb-30">
            ...
            <div className="flex flex-col lg:flex-row justify-center items-center gap-[20px] w-full mx-auto">
                ...
                <div className="w-[387px] h-[496px] rounded-[10px] border-[2px] border-[#E6E3E3] rounded-[10px] ">
                    ...
                    <img className="rounded-bl-[10px] w-[387px] rounded-br-[10px] h-[353px]" src={whyUs3} alt="Home" />
                </div>
            </div>
        </div>
    </div>
