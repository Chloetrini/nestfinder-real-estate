    ...
    <div>
        <div className="flex flex-col justify-center items-center gap-[47px] pb-22 mx-auto container w-11/12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-[30px]">
                <div className="bg-[#EEEEEE] flex flex-col justify-start items-start gap-[20px] md:gap-[40px] h-[185px] py-[10px] px-[20px] shadow-sm  rounded-[10px] md:col-span-2">
                    <p className="font-Inter font-[500] text-start text-[14px] leading-[26px] w-full md:w-[22rem]">Finding my dream Apartment was so easy with Nest Finder Pro. The Listings were accurate, the agents were responsive and i was happy to move in</p>
                ...
                <div className="bg-[#EEEEEE] flex flex-col justify-start items-start gap-[40px] h-[185px] py-[10px] px-[20px] shadow-sm rounded-[10px] md:col-span-2">
                    <p className="font-Inter font-[500] text-start text-[14px] leading-[26px] w-full md:w-[20.5rem]">NestFinder Pro made the whole property search stress free. Their verified listings gave me confidence that what i saw was what i got</p>
                    <div className="flex flex-row justify-center items-center gap-[13px]">
                ...
                <div className="bg-[#EEEEEE] flex flex-col justify-start items-start gap-[40px] h-[185px] py-[10px] px-[20px] shadow-sm rounded-[10px] md:col-span-2">
                    <p className="font-Inter font-[500] text-start text-[14px] leading-[26px] w-full md:w-[20.5rem]">I was skeptical about searching for home online but NestFinder Pro changed that. They are professional, and incredible people i can trust</p>
                    <div className="flex flex-row justify-center items-center gap-[13px]">
                ...
                <div className="bg-[#EEEEEE] flex flex-col justify-start items-start gap-[40px] h-[185px] py-[10px] px-[20px] rounded-[10px] shadow-sm md:col-span-3">
                    <p className="font-Inter font-[500] text-start text-[14px] leading-[26px] w-full md:w-[100%] lg:w-[33rem]">NestFinder Pro made the whole property search stress free. Their verified listings gave me confidence that what i saw was what i got</p>
                    <div className="flex flex-row justify-center items-center gap-[13px]">
                ...
                <div className="bg-[#EEEEEE] flex flex-col justify-start items-start gap-[40px] h-[185px] py-[10px] px-[20px] rounded-[10px] shadow-sm md:col-span-3">
                    <p className="font-Inter font-[500] text-start text-[14px] leading-[26px] w-full md:w-[100%] lg:w-[33rem]">I was skeptical about searching for home online but NestFinder Pro changed that. They are professional, and incredible people i can trust</p>
                    <div className="flex flex-row justify-center items-center gap-[13px]">
