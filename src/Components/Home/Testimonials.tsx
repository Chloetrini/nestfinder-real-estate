    ...
    <div>
        <div className="flex flex-col justify-center items-center gap-[47px] pb-22 max-w-[1200px] w-full px-4 mx-auto container">
            ...
            <div className="flex flex-col justify-center items-center gap-[12px]">
                <p className="font-[Manrope] font-[700] text-[#131817] dark:text-gray-100 text-center text-[16px] uppercase tracking-wider">testimonials</p>
                <h1 className="font-[Manrope] font-[700] text-[#131817] dark:text-gray-100 text-center md:text-[42px] text-[30px] leading-tight px-4">What Our Satisfied Clients Say</h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-6 gap-[30px] w-full">
                ...
                <div className="bg-[#EEEEEE] dark:bg-gray-800 flex flex-col justify-between items-start md:h-[185px] min-h-[185px] py-[20px] px-[20px] shadow-sm rounded-[10px] md:col-span-3 lg:col-span-2">
                    ...
                    <div className="flex flex-row justify-center items-center gap-[13px] mt-4 md:mt-0">
                        ...
                        <h2 className="font-[Raleway] font-[500] text-[18px] text-[#1A1212] dark:text-gray-100">Michael Carter</h2>
                    </div>
                </div>
                ...
                <div className="bg-[#EEEEEE] dark:bg-gray-800 flex flex-col justify-between items-start md:h-[185px] min-h-[185px] py-[20px] px-[20px] shadow-sm rounded-[10px] md:col-span-3 lg:col-span-2">
                    ...
                    <div className="flex flex-row justify-center items-center gap-[13px] mt-4 md:mt-0">
                        ...
                        <h2 className="font-Raleway font-[500] text-[18px] text-[#1A1212] dark:text-gray-100">Sophie Ann</h2>
                    </div>
                </div>
                ...
                <div className="bg-[#EEEEEE] dark:bg-gray-800 flex flex-col justify-between items-start md:h-[185px] min-h-[185px] py-[20px] px-[20px] shadow-sm rounded-[10px] md:col-span-3 lg:col-span-2">
                    ...
                    <div className="flex flex-row justify-center items-center gap-[13px] mt-4 md:mt-0">
                        ...
                        <h2 className="font-[Raleway] font-[500] text-[18px] text-[#1A1212] dark:text-gray-100">Carey- Yin-un</h2>
                    </div>
                </div>

                {/* Micah Richards - col-span-3 */}
                <div className="bg-[#EEEEEE] dark:bg-gray-800 flex flex-col justify-between items-start md:h-[185px] min-h-[185px] py-[20px] px-[20px] rounded-[10px] shadow-sm md:col-span-3">
                    <p className="font-[Inter] font-[500] text-start text-[14px] leading-[26px] w-full">
                        NestFinder Pro made the whole property search stress free. Their verified listings gave me confidence that what i saw was what i got
                    </p>
                    <div className="flex flex-row justify-center items-center gap-[13px] mt-4 md:mt-0">
                        <img className="h-[47px] w-[47px] rounded-full object-cover" src={micah} alt="micah" />
                        <h2 className="font-[Raleway] font-[500] text-[18px] text-[#1A1212] dark:text-gray-100">Micah Richards</h2>
                    </div>
                </div>
                ...
                <div className="bg-[#EEEEEE] dark:bg-gray-800 flex flex-col justify-between items-start md:h-[185px] min-h-[185px] py-[20px] px-[20px] rounded-[10px] shadow-sm md:col-span-3">
                    ...
                    <div className="flex flex-row justify-center items-center gap-[13px] mt-4 md:mt-0">
                        ...
                        <h2 className="font-[Raleway] font-[500] text-[18px] text-[#1A1212] dark:text-gray-100">Emmanuel Bait</h2>
                    </div>
                </div>
