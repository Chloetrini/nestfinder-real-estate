  ...
  return (
    <div className="bg-[url(/src/assets/header.jpg)] bg-no-repeat bg-cover">
        ...
        <div className="container mx-auto flex flex-col justify-center items-center gap-[45px] md:gap-[48px] py-[173px] ">
            ...
            <p className="font-Inter font-[400] text-[14px] md:text-[21px] leading-[34px] text-center text-[#FFFFFF] w-[20rem] md:w-[45rem] ">Unlock your dream home at NestFinder Pro we help you compare discover and make sure you have a lovely stay in your beautiful apartment  </p>

            <button className="bg-[#F4A261] py-[12px] px-[24px] w-[285px] md:w-[145px] rounded-[10px] font-Manrope font-[400] text-[18px] text-[#FFFFFF]" type="submit" onClick={() => isLoggedIn? navigate("/Property") : setShowModal(true)}>Get Started</button>
