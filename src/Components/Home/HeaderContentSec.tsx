  ...
  return (
    <div className="bg-[url(/src/assets/header.jpg)] bg-no-repeat bg-cover ">
        ...
        <div className="container mx-auto flex flex-col justify-center items-center gap-[45px] md:gap-[48px] py-[173px] ">
            ...
            <button className="bg-[#F4A261] py-[12px] px-[24px] w-[285px] md:w-[145px] rounded-[10px] font-[Manrope] font-[400] text-[18px] text-[#FFFFFF] hover:bg-[#f89a4d] transition-all transform hover:scale-105" type="submit" onClick={() => isLoggedIn? navigate("/properties") : setShowModal(true)}>Get Started</button>
