          ...
          >
            ...
            {open && (
              <InfoWindow
                ...
                headerDisabled={true}
              >
                <div className="flex bg-white dark:bg-gray-900 w-full lg:w-[331px] h-[74px] gap-3 items-center relative p-1">
                  <button onClick={() => setOpen(false)}
                   className="absolute top-1 right-1 text-gray-400 hover:text-black dark:hover:text-gray-100 font-bold text-lg leading-none p-1"> &times;</button>
                  <img className="w-[79px] h-full object-cover rounded-[5px]" src={image} alt={propertyName} />
                  <div className="flex flex-col justify-center">
                    <p className="text-[16px] text-gray-800 dark:text-gray-100 leading-tight">{propertyName}</p>
                    <p className="font-bold flex gap-2 items-center text-gray-900 dark:text-gray-100 mt-1">
                      <img src={locationn} className="w-4 h-4 dark:invert" alt="" />
