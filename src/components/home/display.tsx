  ...
  return (
    <div className=" max-w-[1200px] w-full px-8 md:px-4 mx-auto container flex justify-center items-center pb-22">
     <div className="bg-[#00000066] w-full max-w-[1240px] lg:h-[581px] h-[370px] rounded-[10px]">
       ...
       <div className="bg-[url(/src/assets/images/housing.webp)] bg-no-repeat bg-cover  w-full lg:h-[581px] h-[370px] rounded-[10px] relative">
       ...
       <div className="flex flex-col justify-center items-center gap-5 lg:gap-[31px]  lg:w-[622px]  w-[80%] lg:h-[392px] md:h-[220px] h-[250px] absolute bottom-15 left-7 lg:bottom-20 lg:left-10 -translate-y-1.2 backdrop-blur-md bg-white/30 rounded-2xl shadow-xl  ">
            ...
            <div className="bg-[#1A3C34] dark:bg-[#24574a] flex justify-center items-center  max-[321px]:py-[8px]  max-[321px]:px-[18px] py-[12px] px-[24px] rounded-[10px] lg:w-[461px] w-[90%] hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] transition-all transform hover:scale-105 ">
                <button onClick={()=>navigate('/properties')}  className="font-[Manrope] font-400 md:text-[18px] max-[321px]:text-[12px]  text-[14px] text-[#FFFFFF] " type="submit">Explore All Properties</button>
            </div>
