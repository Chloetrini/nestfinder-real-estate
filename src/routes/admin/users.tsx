...
import { useAllUsers, useDeleteUser } from "@/hooks/admin/use-admin";
    ...
    <div className="flex flex-col bg-[#F3F4F6] dark:bg-gray-950 pb-24 lg:pb-10 min-h-screen">
      ...
      <nav className="bg-white dark:bg-gray-900 px-4 lg:px-10 h-[76px] flex items-center border-b border-[#BAB9B9] dark:border-gray-600">
        <div className="flex items-center gap-3">
            ...
            <h1 className="font-['Lato'] font-bold text-[20px] lg:text-[22px] text-[#023337] dark:text-gray-100">Users</h1>
        </div>
      ...
      <div className="px-4 lg:px-10 py-6 lg:py-8">
        ...
        <div className="flex flex-col  justify-between items-start md:items-start mb-8 gap-4">
          <div>
            <h2 className="font-bold text-[20px] lg:text-[22px] text-[#023337] dark:text-gray-100 font-['Lato']">Manage Users</h2>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-[8px] overflow-hidden w-full">
          {users.length === 0 ? (
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[#B1FFED] dark:bg-[#0f3b32] h-[56px]">
                      <th className="text-[15px] font-medium w-[300px] text-[#023337] dark:text-gray-100 px-4 text-left">Email</th>
                      <th className="text-[15px] font-medium  w-[200px] text-[#023337] dark:text-gray-100 px-4 text-left">Status</th>
                      <th className="text-[15px] font-medium w-[200px] text-[#023337] dark:text-gray-100 px-4 text-left">Role</th>
                      <th className="text-[15px] font-mediumw  text-[#023337] dark:text-gray-100 px-4 text-left">Registration Date</th>
                      <th className="text-[15px] font-medium  text-[#023337] dark:text-gray-100 px-4 text-left">Delete</th>
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr key={user._id} className="h-[70px]">
                     <td className="px-4 py-4 font-bold text-[#0A1916] dark:text-gray-100 text-[14px]">{user.email}</td>
                     ...
                     <td className="px-4 py-4 text-[#403F3F] dark:text-gray-300 text-[14px]">{formatDate(user.createdAt)}</td>
            ...
            <div className="flex justify-between items-start">
              <div>
                <p className="font-bold text-[#0A1916] dark:text-gray-100 text-[16px]">{user.email}</p>
