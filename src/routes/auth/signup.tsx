...
import desktop from "@/assets/images/auth-desktop.webp"
...
// ---- BACKEND ADDED: handle modal close ----
  ...
  return (
    <div className="w-full h-screen bg-white dark:bg-gray-900 flex items-center justify-center overflow-hidden font-[Manrope]">
          ...
          >
            <div className="flex flex-col gap-3">
                <div className="flex gap-4 items-center mb-2">
                    ...
                    <h1 onClick={() => navigate("/")} className="text-[#1A3C34] dark:text-[#8fd3c0] font-[Manrope] font-[700] text-[22.17px] hidden md:block cursor-pointer">NestFinder Pro</h1>
                </div>
                ...
                <span className="font-light text-[13px] mb-6 font-[Inter] text-[#525050] dark:text-gray-300">Already have an account?
                    <Link to="/login" className="underline font-medium ml-1 transition-all transform hover:scale-105">Log In</Link>
                </span>
            </div>

            {/* EMAIL FIELD */}
            <label className={`text-[13px] font-medium ${error.email ? "text-red-500" : "text-black dark:text-gray-100"}`} htmlFor="email">Email</label>
            <input
                type="text"
                name="email"
                id="email"
                ...
                ${error.email ? "border-red-500 " : "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500"}`}
            />
            {error.email && (
            ...
            <label className={`text-[13px] font-medium ${error.password ? "text-red-500" : "text-black dark:text-gray-100"}`} htmlFor="password">Password</label>
            <div className="relative w-full">
              <input
                ...
                ${error.password ? "border-red-500" : "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500"}`}
              />
            ...
            <label className={`text-[13px] font-medium ${error.confirmpassword ? "text-red-500" : "text-black dark:text-gray-100"}`}>Confirm Password</label>
            <div className="relative w-full">
              <input
                ...
                className={`w-full h-9 md:h-11.25 p-2 border-2 text-[14px] mb-4 rounded-lg my-2 block focus:outline-none transition-all duration-200 pr-12
                ${error.confirmpassword ? "border-red-500" : "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500"}`}
              />
            ...
            <div className='flex flex-row gap-2 items-center mt-2'>
                ...
                />
                <label htmlFor="terms" className={`text-[12px] ${error.terms ? "text-red-500" : "text-black dark:text-gray-100"}`}>
            ...
            <button 
              disabled={isLoading}
              className="w-full h-[49px] bg-[#1A3C34] dark:bg-[#24574a] rounded-lg text-white font-light my-6 px-[24px] py-[12px] hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] transition-all transform hover:scale-105 disabled:opacity-80 disabled:cursor-not-allowed"
            >
