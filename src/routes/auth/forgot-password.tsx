        ...
        <div className="w-full h-full md:w-1/2 flex md:mt-9 overflow-y-auto px-4 order-2 md:order-1">
          ...
          >
            <div className="flex flex-col gap-3">
              ...
              <label 
                className={`text-[13px] mb-3 font-medium ${error.email ? "text-red-500" : "text-black dark:text-gray-100"}`}
                htmlFor="email"
              >
                Email
              </label>
            ...
            <input
              ...
              className={`w-full h-9 md:h-11.25 p-2 border-2 text-[10px] md:text-[14px] rounded-lg my-0 md:my-2 block focus:outline-none transition-all duration-200
                ${error.email 
                  ...
                  : "border-gray-300 dark:border-gray-600 placeholder-gray-400 focus:ring-2 focus:ring-blue-500"
                }`}
            />
           ...
           {/* ---- BACKEND ADDED: button shows loading state ---- */}
            <button 
              type="submit" 
              disabled={isLoading}
              className="w-full h-[49px] bg-[#1A3C34] dark:bg-[#24574a] rounded-lg text-white text-[14px] font-light block my-6 hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] transition-all transform hover:scale-105 disabled:opacity-80 disabled:cursor-not-allowedn px-[24px] py-[12px] "
            >
