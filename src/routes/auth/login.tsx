...
const LogIn: FC = () => {
  ...
  return (
    <div className="w-full h-screen bg-white dark:bg-gray-900 flex items-center justify-center overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="md:w-[507px] w-full flex flex-col mx-auto px-2 pb-10 md:pb-0 pt-4 md:pt-6">
            <div className="flex flex-col gap-3">
              ...
              <h4 
                ...
                className="text-[17px] md:text-[32px] font-[700] font-[Manrope] md:cursor-default cursor-pointer text-[#081411] dark:text-gray-100"
              >
                Log in
              </h4>
              <p className="mb-4 text-[11px] md:text-[13px] font-[Inter] text-[#525050] dark:text-gray-300">welcome back, Please enter your details</p>
            </div>

            <label className={`text-[13px] ${error.email ? "text-red-500" : "text-black dark:text-gray-100"}`}>Email</label>
            <input 
              type="text" 
              name="email" 
              id="email"
              ...
              className={`w-full font-[Manrope] font-[400] h-11.25 p-2 border-2 text-[14px] mb-4 rounded-lg my-2 focus:outline-none transition-all duration-200
               ${error.email ? "border-red-500 placeholder-red-500" : "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 placeholder-gray-400"}`}
            />
            ...
            <label className={`text-[13px] font-[Manrope] font-medium ${error.password ? "text-red-500" : "text-black dark:text-gray-100"}`}>Password</label>
            ...
            <div className="relative w-full mb-4">
              <input 
                ...
                className={`w-full h-11.25 p-2 border-2 font-[Manrope] text-[14px] rounded-lg my-2 focus:outline-none transition-all duration-200 pr-12
                 ${error.password ? "border-red-500 placeholder-red-500" : "border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 placeholder-gray-400"}`}
              />
            ...
            <button 
              disabled={isLoading}
              className="w-full font-[Manrope] h-[49px] bg-[#1A3C34] dark:bg-[#24574a] rounded-lg text-white font-light my-6 hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] transform hover:scale-105 px-[24px] py-[12px] disabled:opacity-80 disabled:cursor-not-allowed">
