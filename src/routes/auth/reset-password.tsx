      ...
      <div className="flex flex-col md:flex-row w-full h-full max-w-[1600px] mx-auto">
        <div className="w-full h-full md:w-1/2 flex md:mt-9 overflow-y-auto px-4 order-2 md:order-1">
          ...
          >
            ...
            <label
              className={`text-[13px] font-medium pb-1.5 md:pb-0 ${error.password ? "text-red-500" : "text-black dark:text-gray-100"}`}
              htmlFor="password"
            >
              Password
            </label>
               ...
               <input
                 type={showPassword ? "text" : "password"}
                  ...
                  className={`w-full h-9 md:h-11.25 p-2 border-2 text-[10px] md:text-[14px] mb-4 rounded-lg my-0 md:my-2 block focus:outline-none transition-all duration-200
                    ${error.password ? "border-red-500 placeholder-red-500" : "border-gray-300 dark:border-gray-600 placeholder-gray-400"}`}
            />
                {/* Eye icon button for password */}
                <button
                  type="button"
                  onClick={togglePasswordVisibility}
                  className="absolute right-3 md:top-1/2 top-4.5 transform -translate-y-1/2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition-colors duration-200"
            ...
            <label
              className={`text-[13px] font-medium pb-1.5 md:pb-0 ${error.confirmpassword ? "text-red-500" : "text-black dark:text-gray-100"}`}
            ...
            <div className="relative w-full">
              ...
              onChange={handleChange}
              className={`w-full h-9 md:h-11.25 p-2 border-2 text-[10px] md:text-[14px] mb-4 rounded-lg my-0 md:my-2 block focus:outline-none transition-all duration-200
                ${error.confirmpassword ? "border-red-500 placeholder-red-500" : "border-gray-300 dark:border-gray-600 placeholder-gray-400"}`}
            />
            ...
            <button
              disabled={isLoading}
              className="w-full h-[49px] bg-[#1A3C34] dark:bg-[#24574a] rounded-lg text-white text-[14px] font-light block my-4 md:my-8 hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] transition-all transform hover:scale-105 disabled:opacity-80 disabled:cursor-not-allowedn px-[24px] py-[12px] "
            >
