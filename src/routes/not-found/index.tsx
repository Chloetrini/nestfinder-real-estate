  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        <Link to="/">
          <button className="px-8 py-3 bg-[#1A3C34] dark:bg-[#24574a] hover:bg-[#264d43] dark:hover:bg-[#2d6a5a] text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-lg">
            Back to Home
          </button>
        </Link>
      </div>
